package com.skripsi.scheduleplus.FilePicker;
...
import com.skripsi.scheduleplus.FilePicker.SelectionMode;
...
public class FileDialog extends ListActivity {
		...
		selectButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (selectedFile != null) {
					...
					getIntent().putExtra(RESULT_FILENAME, selectedFile.getName());
	...
	private void getDirImpl(final String dirPath) {
		...
		if (!currentPath.equals(ROOT)) {
			...
			item.add(ROOT);
			addItem(ROOT, R.drawable.directory_icon);
			path.add(ROOT);
